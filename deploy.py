#!/usr/bin/env python3
"""
Deployment script for PII Detection and Masking Tool
...
class PIIDeployment:
    ...
    def __init__(self):
        ...
        self.main_script = self.project_root / "detector_maak.py"
    ...
    def generate_usage_examples(self):
        ...
        examples = {
            "basic_usage": "python detector_maak.py input.csv",
            "custom_output": "python detector_maak.py input.csv -o output.csv",
            "sample_data": "python detector_maak.py examples/sample_input.csv",
    ...
    def deployment_summary(self):
        ...
        print("\n📁 Project Structure:")
        print("   ├── detector_maak.py (Main script)")
        ...
        print("      python detector_maak.py your_data.csv")
